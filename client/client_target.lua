...
exports['qb-target']:AddBoxZone("EastsideRepairZone", vector3(891.09, -2117.75, 30.46), 50, 60, {
  ...
  exports['qb-target']:AddBoxZone("BennyMainRepair", vector3(-335.83, -136.66, 38.53), 30, 50, { -- The name has to be unique, the coords a vector3 as shown, the 1.5 is the length of the boxzone and the 1.6 is the width of the boxzone, the length and width have to be float values
  name = "LSMainRepair", 
  heading = 250.00, 
  debugPoly = false, 
  minZ = 37.73, 
